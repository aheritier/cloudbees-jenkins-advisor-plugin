...
public class AdvisorRootConfiguratorTest {
  ...
  public void setUpConfigurator() {
    ...
    configuration = new AdvisorGlobalConfiguration(FAKE_EMAIL, EXCLUDED, FAKE_CC);
  ...
  public void testCanConfigure() {
    ...
    assertFalse("Can configure AdvisorRootConfigurator",
      configurator.canConfigure(AdvisorRootConfigurator.class));
  }
  ...
  public void testDescribeWithEmptyEmail() throws Exception {
    final AdvisorGlobalConfiguration c = new AdvisorGlobalConfiguration("", EXCLUDED, FAKE_CC);
  ...
  public void testDescribeWithNullEmail() throws Exception {
    final AdvisorGlobalConfiguration c = new AdvisorGlobalConfiguration(null, EXCLUDED, FAKE_CC);
    c.setAcceptToS(ACCEPT_TOS);
    c.setNagDisabled(NAG_DISABLED);
  ...
  public void testDescribeWithEmptyCC() throws Exception {
    final AdvisorGlobalConfiguration c = new AdvisorGlobalConfiguration(FAKE_EMAIL, EXCLUDED, Collections.emptyList());
    c.setAcceptToS(ACCEPT_TOS);
    c.setNagDisabled(NAG_DISABLED);
  ...
  public void testDescribeWithNullCC() throws Exception {
    final AdvisorGlobalConfiguration c = new AdvisorGlobalConfiguration(FAKE_EMAIL, EXCLUDED, null);
    c.setAcceptToS(ACCEPT_TOS);
    c.setNagDisabled(NAG_DISABLED);
  ...
  public void testDescribeWithNullExcluded() throws Exception {
    final AdvisorGlobalConfiguration c = new AdvisorGlobalConfiguration(FAKE_EMAIL, null, FAKE_CC);
    c.setAcceptToS(ACCEPT_TOS);
    c.setNagDisabled(NAG_DISABLED);
  ...
  public void testDescribeWithEmptyExcluded() throws Exception {
    final AdvisorGlobalConfiguration c = new AdvisorGlobalConfiguration(FAKE_EMAIL, new HashSet<>(), FAKE_CC);
    c.setAcceptToS(ACCEPT_TOS);
    c.setNagDisabled(NAG_DISABLED);
